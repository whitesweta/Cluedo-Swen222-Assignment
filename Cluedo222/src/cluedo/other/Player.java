...
/**
 * Represents a Player in the Game. The users can choose how many players they want to create for 
 * the current game.
...
public class Player {
	 ...
	 * @param c The character this player has chosen to be represented by
	 ...
	 * @param p the position they want to be moved to
	 */
	...
	/**
	 * @return returns true if the player has been elimnated, false if still in the game 
	 */
	 ...
	 * @param eliminated true if eliminated
	 */
	...
	/**
	 * Sets initial position of the player when game has just started, depending on what character they have chosen to be
	 */
	...
	/**
	 * @return Returns a card in this players hand if it matches one of the ones suggested. returns null if no cards match
	 * @param chosenTypes a set of the types that have been suggested by another player to check against
	 */
